...
apply Hp. 
Qed. 
(* Find f such that foldl f id l [] = reverse l Answer : f g x = fun l => x::g l *)
...
Lemma funny_fold_gen_exercise : forall (A: Type) (l l' : list A) (h : list A -> list A), foldl f h l l' = revInto l (h l'). 
Proof. 
Admitted. 

Lemma funny_fold_exercise : forall (A: Type) (l : list A), foldl f id l [] = reverse l. Proof. Admitted.